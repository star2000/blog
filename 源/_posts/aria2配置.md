...
```bat
cmd /c echo CreateObject("WScript.Shell").Run "aria2c --enable-rpc -d%USERPROFILE%\Downloads -k1M -x16 -c -s1024",0 > "%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup\aria2.vbs"
```
